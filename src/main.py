...
class T5FineTuner(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # scheduler = {
        #     "scheduler":
        #     ReduceLROnPlateau(optimizer, mode='max', patience=2, factor=0.01, verbose=True),
        #     "interval":"step",
        # }
        # The lr scheduler dict must include a monitor when a `ReduceLROnPlateau` scheduler is used.
        # For example: {"optimizer": optimizer,
        #               "lr_scheduler": {"scheduler": scheduler, "monitor": "your_loss"}
        #              }
...
def train_function(args):
    ...
    if args.do_train:
        ...
        tokenizer = T5Tokenizer.from_pretrained(args.model_name_or_path,
                                                local_files_only=True if args.model_name_or_path != "t5-base" else False)
        ...
        # tfm_model = MyT5ForConditionalGeneration.from_pretrained("t5-base-model")
